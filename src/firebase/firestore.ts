...
export const createUserDoc = (uid: string, data: DocumentData) => setDoc(doc(db, "users", uid), data);
// Get a user document by UID
export const getUserDoc = (uid: string) => getDoc(doc(db, "users", uid));
// Update a user document by UID
export const updateUserDoc = (uid: string, data: DocumentData) => updateDoc(doc(db, "users", uid), data);
...
// --- Product CRUD ---
// Add a new product
export const addProduct = (data: DocumentData) => addDoc(collection(db, "products"), data);
// Get all products
export const getProducts = () => getDocs(collection(db, "products"));
// Update a product by ID
export const updateProduct = (id: string, data: DocumentData) => updateDoc(doc(db, "products", id), data);
// Delete a product by ID
export const deleteProduct = (id: string) => deleteDoc(doc(db, "products", id));

// --- Order CRUD ---
// Add a new order (with server timestamp)
export const addOrder = (data: DocumentData) =>
